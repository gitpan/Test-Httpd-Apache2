# This Makefile is for the Test::Httpd::Apache2 extension to perl.
#
...
#     ABSTRACT => q[Apache2 runner for tests]
#     AUTHOR => q[Cybozu Labs, Inc.  Written by Kazuho Oku.]
#     DIR => []
#     DISTNAME => q[Test-Httpd-Apache2]
#     NAME => q[Test::Httpd::Apache2]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::TCP=>q[0], ExtUtils::MakeMaker=>q[6.42], LWP::Simple=>q[0], Class::Accessor::Lite=>q[0] }
#     VERSION => q[0.02]
#     dist => {  }
...
MAKE = make
FULLEXT = Test/Httpd/Apache2
BASEEXT = Apache2
PARENT_NAME = Test::Httpd
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Test/Httpd/Apache2.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Test/Httpd
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Test/Httpd
...
TO_INST_PM = lib/Test/Httpd/Apache2.pm

PM_TO_BLIB = lib/Test/Httpd/Apache2.pm \
...
DISTNAME = Test-Httpd-Apache2
DISTVNAME = Test-Httpd-Apache2-0.02
...
manifypods : pure_all  \
	lib/Test/Httpd/Apache2.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Test/Httpd/Apache2.pm $(INST_MAN3DIR)/Test::Httpd::Apache2.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Apache2 runner for tests</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Cybozu Labs, Inc.  Written by Kazuho Oku.</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-Accessor-Lite" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Test-TCP" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Test/Httpd/Apache2.pm blib/lib/Test/Httpd/Apache2.pm 
